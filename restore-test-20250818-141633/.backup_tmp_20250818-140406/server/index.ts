...
(async () => {
  ...
  // Register object storage migration routes
  const storageMigrationRoutes = await import("./routes/storage-migration.js");
  app.use("/api/storage", storageMigrationRoutes.default);
