...
// Missing header navigation pages
const Subscriptions = lazy(() => import("@/pages/subscriptions"));
const SpiralCenters = lazy(() => import("@/pages/spiral-centers-subscription-demo"));
const AdvancedLogistics = lazy(() => import("@/pages/advanced-logistics"));
const AIRetailerSignup = lazy(() => import("@/pages/ai-retailer-signup"));
const AIRetailerDemo = lazy(() => import("@/pages/ai-retailer-demo"));
const TrustedLocalStores = lazy(() => import("@/pages/trusted-local-stores"));
const Loyalty = lazy(() => import("@/pages/loyalty-retailers"));
const Wallet = lazy(() => import("@/pages/wallet"));
const Orders = lazy(() => import("@/pages/orders"));
const Onboarding = lazy(() => import("@/pages/retailer-onboarding-demo"));
const AdminRetailerApplications = lazy(() => import("@/pages/admin-retailer-applications"));
