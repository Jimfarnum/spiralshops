...
export default function MobileNav({ className }: MobileNavProps) {
  ...
  const navItems = [
    { to: "/", icon: Home, label: "Discover", description: "Explore local businesses" },
    { to: "/products", icon: Package, label: "Products", description: "Browse all products" },
    { to: "/malls", icon: Building2, label: "Malls", description: "Shopping centers" },
    { to: "/subscriptions", icon: Package, label: "Subscriptions", description: "Subscription services" },
    { to: "/spiral-centers", icon: MapPin, label: "SPIRAL Centers", description: "Logistics network" },
    { to: "/advanced-logistics", icon: Truck, label: "Advanced Logistics", description: "Delivery management" },
    { to: "/stores", icon: Heart, label: "Local Stores", description: "Browse all stores" },
    { to: "/social-feed", icon: Users, label: "Community", description: "Connect with locals" },
  ];
