      ...
      <section className="py-20 bg-[var(--spiral-cream)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 px-4">
            ...
            {/* Cross-Retailer Search - NEW REVOLUTIONARY FEATURE */}
            <Link to="/cross-retailer" className="group">
              <div className="w-full max-w-[300px] mx-auto md:mx-0 py-4 px-4 rounded-xl shadow-md bg-gradient-to-br from-indigo-600 to-blue-500 text-white transform transition-all duration-300 hover:scale-105 hover:shadow-xl cursor-pointer touch-target relative overflow-hidden">
                <div className="absolute top-2 right-2 bg-yellow-400 text-black text-xs px-2 py-1 rounded-full font-bold animate-pulse">NEW</div>
                <div className="flex items-center gap-4 text-left">
                  <div className="text-3xl">🔗</div>
                  <div>
                    <h3 className="text-lg font-semibold mb-1 font-['Poppins']">Cross-Retailer</h3>
                    <p className="text-sm text-white/90 font-['Inter']">Search ALL local stores at once</p>
                  </div>
                </div>
              </div>
            </Link>
            ...
            <Link to="/intelligent-wishlist" className="group">
              <div className="w-full max-w-[300px] mx-auto md:mx-0 py-4 px-4 rounded-xl shadow-md bg-gradient-to-br from-purple-600 to-violet-500 text-white transform transition-all duration-300 hover:scale-105 hover:shadow-xl cursor-pointer touch-target relative overflow-hidden">
                <div className="absolute top-2 right-2 bg-yellow-400 text-black text-xs px-2 py-1 rounded-full font-bold">AI</div>
                <div className="flex items-center gap-4 text-left">
                  <div className="text-3xl">🧠</div>
                  <div>
                    <h3 className="text-lg font-semibold mb-1 font-['Poppins']">AI Intelligence</h3>
                    <p className="text-sm text-white/90 font-['Inter']">Smart recommendations & price predictions</p>
                  </div>
                </div>
              </div>
            </Link>
            ...
            {/* Fulfillment Dashboard - NEW */}
            <Link to="/admin/fulfillment" className="group">
              <div className="w-full max-w-[300px] mx-auto md:mx-0 py-4 px-4 rounded-xl shadow-md bg-gradient-to-br from-blue-600 to-indigo-600 text-white transform transition-all duration-300 hover:scale-105 hover:shadow-xl cursor-pointer touch-target relative overflow-hidden">
                <div className="absolute top-2 right-2 bg-yellow-400 text-black text-xs px-2 py-1 rounded-full font-bold animate-pulse">MVP</div>
                <div className="flex items-center gap-4 text-left">
                  <div className="text-3xl">🚚</div>
                  <div>
                    <h3 className="text-lg font-semibold mb-1 font-['Poppins']">Fulfillment Hub</h3>
                    <p className="text-sm text-white/90 font-['Inter']">Local logistics & delivery network</p>
                  </div>
                </div>
              </div>
            </Link>
            ...
            <Link to="/shopper-onboarding-walkthrough" className="group">
              <div className="w-full max-w-[300px] mx-auto md:mx-0 py-4 px-4 rounded-xl shadow-md bg-gradient-to-br from-green-500 to-teal-600 text-white transform transition-all duration-300 hover:scale-105 hover:shadow-xl cursor-pointer touch-target relative overflow-hidden">
                ...
                <div className="flex items-center gap-4 text-left">
                  <div className="text-3xl">🚀</div>
                  <div>
                    <h3 className="text-lg font-semibold mb-1 font-['Poppins']">Get Started</h3>
                    <p className="text-sm text-white/90 font-['Inter']">Personalize your shopping experience</p>
                  </div>
                </div>
              </div>
            </Link>
