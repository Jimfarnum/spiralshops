  ...
  return (
    <ErrorBoundary>
      ...
      <section id="press-release" className="bg-gradient-to-r from-gray-50 to-gray-100 px-4 sm:px-6 py-8 sm:py-12 rounded-xl sm:rounded-2xl shadow-lg text-center max-w-5xl mx-auto my-6 sm:my-8">
        ...
        <Link to="/about">
          <button className="inline-block px-4 py-3 sm:px-6 bg-black text-white rounded-lg sm:rounded-xl shadow hover:bg-gray-900 transition-colors text-sm sm:text-base touch-target">
